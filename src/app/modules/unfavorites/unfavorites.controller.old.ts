...
//   );
// };
// const getUnFavouritesByWhoByUserId = (req: Request, res: Response) => {
//   const token_id = req.user?.token_id;
//   let user_id: string | null = null;
...
//     sql,
//     [bio_id, "like"],
//     (err: { message: any }, rows: { count: any }[]) => {
//       console.log(err);
//       if (err) {
//         return res.send({
//           message: err?.message,
...
//       db.query(deleteSql, [userId], (err: any, _results: any) => {
//         if (err) {
...
//             .json({
//               success: true,
//               message: "unfavorites deleted successfully",
//             });
//         }
//       });
//     }
