...
const educational_qualification_constant_1 = require("./educational_qualification.constant");
...
const updateEducationalQualification = (req, res) => {
    ...
    db_1.default.beginTransaction((err) => {
        ...
        db_1.default.query(checkUserSql, [userId], (err, userResults) => {
            ...
            const updateSql = `UPDATE educational_qualification SET ${updateFields.join(", ")} WHERE id = ?`;
