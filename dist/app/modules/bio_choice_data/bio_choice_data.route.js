...
BioChoiceDataRouter.route("/bio-data/:id").put((0, auth_1.auth)("user", "admin"), bio_choice_data_controller_1.BioChoiceDataController.updateBioChoiceData);
...
BioChoiceDataRouter.route("/bio-share").get((0, auth_1.auth)("user", "admin"), bio_choice_data_controller_1.BioChoiceDataController.getBioChoiceDataOfShare);
