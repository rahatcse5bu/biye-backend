...
const expected_lifepartner_constant_1 = require("./expected_lifepartner.constant");
...
const createExpectedLifePartner = (req, res) => {
    ...
    const insertSql = `INSERT INTO expected_lifepartner (
    	${expected_lifepartner_constant_1.ExpectedLifePartnerFields.join(",")}
  ) VALUES (${(0, generatePlaceholders_1.generatePlaceholders)(expected_lifepartner_constant_1.ExpectedLifePartnerFields.length)})`;
    const ExpectedLifePartner = [];
    expected_lifepartner_constant_1.ExpectedLifePartnerFields.forEach((field) => {
...
const updateExpectedLifePartner = (req, res) => {
    ...
    db_1.default.beginTransaction((err) => {
        ...
        db_1.default.query(checkUserSql, [userId], (err, userResults) => {
            ...
            const updateSql = `UPDATE expected_lifepartner SET ${updateFields.join(", ")} WHERE id = ?`;
