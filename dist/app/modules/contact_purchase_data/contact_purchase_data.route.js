...
ContactPurchaseDataRouter.route("/").post((0, auth_1.auth)("user", "admin"), contact_purchase_data_controller_1.ContactPurchaseDataController.createContactPurchaseData);
