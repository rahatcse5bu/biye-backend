...
const createPayments = (req, res) => {
    ...
    const insertSql = `INSERT INTO bio_choice_data (
    	${payments_constant_1.PaymentsFields.join(",")}
  ) VALUES (${(0, generatePlaceholders_1.generatePlaceholders)(payments_constant_1.PaymentsFields.length)})`;
    const BioChoiceData = [];
    payments_constant_1.PaymentsFields.forEach((field) => {
